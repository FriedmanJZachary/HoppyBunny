...
//  HoppyBunny
//
//  Created by Zachary Friedman on 6/22/16.
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func touchesBegan(touches: Set<UITouch>, withEvent event: UIEvent?) {
        ...
        hero.physicsBody?.applyImpulse(CGVectorMake(0, 650))
        let flapsound = SKAction.playSoundFileNamed("sfx_flap.caf", waitForCompletion: false)
